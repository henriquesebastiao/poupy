...
class WebsiteURLsTest(TestCase):
    ...
    def test_if_url_website_home_render_resolve_correct_view(self):
        """Verifica se a url da página inicial do site renderiza a view correta"""
        self.assertEqual(resolve('/').func.__name__, 'home')

    def test_is_url_website_home_return_status_code_200(self):
